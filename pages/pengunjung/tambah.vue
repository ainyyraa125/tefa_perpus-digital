        ...
        <form>
          ...
          <div class="mb-3">
            <div class="row">
              ...
              <div class="col-md-4">
                <select class="from-control form-control-lg form-select rounded-5 mb-2">
          ...
          <nuxt-link to="../pengunjung"><button type="submit" class="btn btn-dark btn-lg rounded-5 px-5 bg-yellow">KIRIM</button></nuxt-link>
        </form>
      </div>
    </div>
  </div>
